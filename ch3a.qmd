...
10. The raw XML content is transformed to an [XML element tree](https://docs.python.org/3/library/xml.etree.elementtree.html)
...
12. Iterate over the individual records that `xpath()` returned.
...
20. the records should be written to a file...
